...
```
5. run ```pip install -r requirements.txt``` and ```python __main__.py```
...
4. install required libraries (**python-docx** and **%your-vendor-name-SQL%**) and run ```python __main__.py```